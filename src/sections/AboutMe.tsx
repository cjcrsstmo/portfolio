  ...
  return (
    ...
    <section className='min-h-screen' id='aboutme' >
      ...
      <div className='flex flex-col items-center justify-center pt-20 xl:pt-15 mb-10 lg:mb-15 xl:mb-20 w-fit mx-auto'>
        ...
        <p className='border-b-17 border-primary-content -translate-y-3 w-2/3 z-0' data-aos="zoom-in-up"></p>
      </div>
      ...
      <div className='flex justify-center items-center w-3/5 px-auto mx-auto h-auto'>
        <div className='flex gap-20 justify-evenly items-center w-full flex-col xl:flex-row my-auto'>
          ...
          {/* Profile Picture */}
          <div className='w-40 xl:w-max  border-2 rounded-xl border-primary'data-aos="fade-right">
            <img  src={ProfilePic}  alt="profile" className='rounded-xl w-40 sm:w-82 translate-6' data-aos="fade-right"/>
          </div>
          ...
          <div className='flex flex-col items-center justify-center w-full lg:w-1/2 sm:mt-0' data-aos="fade-left">
            ...
            <br />
            <p className="text-white text-lg sm:text-xl md:text-xl leading-10 text-justify opacity-90">
              My <span className="text-primary font-bold">eagerness</span> and <span className="text-primary font-bold">dedication</span> to mastering the art of full-stack development, combined with my <span className="text-primary font-bold">enthusiasm</span> for crafting engaging web interfaces, drive my desire to contribute meaningfully to the unending innovation in the field of web development.
            </p>
          </div>
        </div>
      </div>
